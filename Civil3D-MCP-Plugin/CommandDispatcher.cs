...
public static class CommandDispatcher
{
  ...
  return method switch
  {
      ...
      "listOpenDocuments" => DrawingCommands.ListOpenDocumentsAsync(),
      "setActiveDocument" => DrawingCommands.SetActiveDocumentAsync(parameters),
      ...
      "createMLeader" => AcadCommands.CreateMLeaderAsync(parameters),
      "listTextEntities" => AcadCommands.ListTextEntitiesAsync(parameters),
      "listPolylineEntities" => AcadCommands.ListPolylineEntitiesAsync(parameters),
      "listDimensions" => DimensionViewportCommands.ListDimensionsAsync(parameters),
      ...
      "updateBlockReference" => AcadCommands.UpdateBlockReferenceAsync(parameters),
      "eraseEntity" => AcadCommands.EraseEntityAsync(parameters),
